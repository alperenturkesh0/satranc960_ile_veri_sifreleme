...
def on_decrypt():
    ...
    if not text.strip():
        messagebox.showerror("Hata", "Lütfen deşifrelenecek metni girin.")
        return
    try:
        ...
        messagebox.showerror("Hata", f"Deşifreleme sırasında bir hata oluştu: {str(e)}")
...
notebook.add(frame_decrypt, text="Deşifreleme")
